...
//    public void accseso(String usuario, String Clave) {
//        try {
//            statement = dbConecta.createStatement();
//            rs = statement.executeQuery("SELECT K_IDADMIN, K_IDCLAVEADMIN FROM ADMINISTRADOR WHERE (K_IDADMIN='" + usuario + "') and (K_IDCLAVEADMIN='" + Clave + "')");
//            if (rs.next()) {
//
...
//    }
//
//    public void accsesoEstud(String usuario, String Clave) {
//        try {
//            statement = dbConecta.createStatement();
//            
//            rs = statement.executeQuery("SELECT K_IDESTUDIANTE, K_CLAVESTUDIANTE FROM ESTUDIANTE WHERE (K_IDESTUDIANTE='" + usuario + "') and (K_CLAVESTUDIANTE='" + Clave + "')");
//            if (rs.next()) {
//
//                JOptionPane.showMessageDialog(null, "Logueo Correcto");
//                ModificarEstudiante ME = new ModificarEstudiante();
//                ME.setVisible(true);
//            } else {
//                JOptionPane.showMessageDialog(null, "Usuario o Clave Incorrecto");
//
...
//    public void actualizar(String codigo,String clave, String nombre, String apellido, String correo, String proyecto, String facultad, String valorm){
//    try {
//            statement = dbConecta.createStatement();
//            rs = statement.executeQuery("UPDATE ESTUDIANTE SET K_CLAVESTUDIANTE='"+clave+"', N_NOMBRESTUDIANTE='"+nombre+"', N_APELLIDOESTUDIANTE='"+apellido+"', D_CORREO='"+correo+"',D_PROYECTOCURRICULAR='"+proyecto+"',D_FACULTAD='"+facultad+"',D_VALORMATRICULA='"+valorm+"' WHERE K_IDESTUDIANTE='"+codigo+ "' ");
//            if (rs.next()) {
//
//                JOptionPane.showMessageDialog(null, "Se modificaron los Registros Correctamente");
//                
//            } else {
